...
export const ui: Record<Locale, Record<string, string>> = {
  pt: {
    ...
    "projects.archiveHeading": "// mais {count} projetos entregues",
    ...
    "contact.card1Sub": "nível {level} · pico: Top {rank} Brasil",
    ...
    "contact.hireEyebrow": "★ hero · pico: top {rank} brasil · {rating}/5",
  ...
  en: {
    ...
    "projects.archiveHeading": "// {count} more projects delivered",
    ...
    "contact.card1Sub": "{level} level · peak: Top {rank} Brazil",
    ...
    "contact.hireEyebrow": "★ hero · peak: top {rank} brazil · {rating}/5",
