...
export const siteConfig: SiteConfig = {
  ...
  bio: "145+ projetos entregues | 28 clientes recorrentes | Top 2 Brasil e Top 3 Global em TI na Workana entre 14,15M de profissionais. Desenvolvedor Full Stack Sênior — da arquitetura ao deploy. Especializado em SaaS, dashboards e aplicativos modernos.",
  social: {
