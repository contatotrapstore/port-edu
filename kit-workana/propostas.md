...
- O catálogo de serviços foi ampliado em `contexto-claude-workana.md`: web, CMS, comércio eletrônico, backend, mobile, desktop, dados/BI, plataformas empresariais, automação, IA, cloud e melhoria de software existente. Não descartar por ser PHP, WordPress, Wix, Power Apps, Salesforce ou outra tecnologia fora da lista antiga. Unity/Godot entram apenas quando a parte de programação puder ser delimitada e testada com os recursos disponíveis.
- Catálogo amplo não significa especialidade comprovada em todas as stacks. Antes de assumir, verificar escopo testável, documentação, acessos, licenças, ambiente de desenvolvimento e validação. Se faltarem condições essenciais, registrar a pendência; não inventar casos, certificações ou anos de experiência.
- Preservar mínimo de R$ 2.000 por projeto e preferência por 0–10 concorrentes. São regras comerciais do Eduardo, não garantia de conversão. Serviços presenciais e trabalho físico com hardware continuam fora.
- Não mencionar Claude Code, Codex ou assistentes internos de programação por padrão. A proposta explica a entrega. Se o cliente perguntar ou restringir o uso, responder com honestidade e respeitar a condição. IA como funcionalidade do produto é outro assunto e entra quando fizer parte do escopo.
- Os modelos abaixo são exemplos de organização. Adaptar também a manutenção, CMS, lojas, BI, auditorias e outros serviços, com o primeiro entregável e a prova pertinentes. Não enviar o mesmo texto em massa nem assumir compromisso comercial sem autorização da sessão.
