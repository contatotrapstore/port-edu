...
O **C3 fica de fora** por enquanto: o gancho dele ("Sua operação cresceu. Seus
sistemas, não.") é o mesmo do C1, que teve zero conversa nas duas campanhas.
Os arquivos ficam prontos para um teste futuro.
...
**Proibido:** publicar sem eu escrever PUBLICAR; **editar o conjunto de
anúncios** em qualquer campo (orçamento, público, posicionamento, agenda) —
nada nele muda, para não reiniciar o aprendizado; mexer no rascunho antigo
"Novo anúncio de Tráfego"; mexer na campanha de Tráfego, que está pausada;
mexer em pagamento ou limite de gastos; aceitar recomendação, "Aplicar agora"
ou melhoria de IA.

Se um caminho não existir como descrevo, procure o equivalente e me diga onde
achou. Se não achar, escreva NÃO ENCONTREI.

### Etapa 1 — conferir as imagens na biblioteca

Precisam estar em "Imagens da conta", com estes nomes e tamanhos:
...
(`c1-operacao-cresceu-*`, `c2-prova-*`): elas trazem a oferta errada,
...
- **Tipo: Perguntas frequentes** (perguntas de escolha), **não** mensagem
  ...
  frequentes: é o que corta o toque sem intenção.
- Saudação: `Oi! Aqui é o Eduardo, da EDevsHub. Me conta o que a sua empresa faz e como a equipe controla os pedidos hoje, que eu te digo faixa de preço e prazo. Projetos começam em R$ 5 mil.`
...
Cuidados que já nos morderam antes: personalize **uma imagem por vez e salve
entre uma e outra**, senão a Meta reagrupa. Remova as versões automáticas de
proporção e deixe cada uma em "Mídia original". Depois de duplicar, confira que
as 5 melhorias Advantage+ e os 4 aprimoramentos essenciais estão desligados,
que a música está desligada e que "vários anunciantes" está desmarcado.
...
pergunta em afirmação sobre o serviço, e isso muda a arte também.
